...
namespace hw1 {
    ...
    public partial class MyDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class MyTableDataTable : global::System.Data.TypedTableBase<MyTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public MyTableRow AddMyTableRow(string Name, int Age) {
            ...
            public string Name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Name\' в таблице \'MyTable\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public int Age {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Age\' в таблице \'MyTable\' равно DBNull.", e);
                    }
                }
                set {
...
namespace hw1.MyDatabaseDataSetTableAdapters {
    ...
    public partial class MyTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[MyTable] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[MyTable] ([Name], [Age]) VALUES (@Name, @Age);\r\nSELECT Id, Nam" +
                "e, Age FROM MyTable WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[MyTable] SET [Name] = @Name, [Age] = @Age WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)));
SELECT Id, Name, Age FROM MyTable WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=DESKTOP-V5PMT18\\SQLEXPRESS;Initial Catalog=MyDatabase;Integrated Secu" +
                "rity=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Age FROM dbo.MyTable";
